<template>
    <div class="container pt-5">
        <router-link class="nav-link" :to="{name: 'login'}">
            <i class="fas fa-arrow-left back-btn" style="font-size: 40pt;"></i>
        </router-link>
        
        <use>
            <svg style="margin-top: -20px;" version="1.1" 
        ...
        <h1 class="h403">403</h1>
        <h2 class="h403-2">ACCESS NOT GRANTED, PLEASE GO BACK!</h2>       
    </div>
</template>
